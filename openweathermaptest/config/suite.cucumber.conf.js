...
exports.config = {
    ...
    specs: [
        './openweathermaptest/features/*.feature',
    ...
    screenshotPath: './openweathermaptest/reports/errorShots/',   // Saves a screenshot to a given path if a command fails.
    //
    ...
    reporterOptions: {
        junit:  {outputDir: './openweathermaptest/reports/junit-results/'},
        json:   {outputDir: './openweathermaptest/reports/json-results/'},
        allure: {
          outputDir:   './openweathermaptest/reports/allure-results/',
    ...
    cucumberOpts: {
        require: ['./openweathermaptest/stepDefinitions/given.js', './openweathermaptest/stepDefinitions/when.js', './openweathermaptest/stepDefinitions/then.js'],   // <string[]> (file/dir) require files before executing features
